            ...
            <div className="w-full h-auto px-[64px]">
                <div className="w-[1232px] h-[1078px] ml-[10px] flex flex-col items-center justify-center text-black">
                    <div className="mb-[50px]">
                        <h1 className="text-center text-6xl font-bold">LEMON GARLIC</h1>
                        <br />
                        <h1 className="text-center text-6xl font-bold">ROASTED CHICKEN</h1>
                    ...
                    <Image src={"/recipe2.png"} alt="recipe1" width={1232} height={640}></Image>
                </div>
