        ...
        <>
            <div className="w-full h-auto px-4 sm:px-8 md:px-12 lg:px-16">
                ...
                <div className="w-full max-w-[1232px] mx-auto mb-12">
                    <Image src="/recipe1.png" alt="recipe1" width={1232} height={640} />
                </div>
...
//                         <h1 className="text-6xl font-bold">SAVORY HERB-INFUSED</h1>
//                         <br />
//                         <h1 className="text-center text-6xl font-bold">CHICKEN</h1>
...
//                     <Image src={"/recipe1.png"} alt="recipe1" width={1232} height={640}></Image>
//                 </div>
