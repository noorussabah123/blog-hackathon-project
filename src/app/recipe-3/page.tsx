            ...
            <div className="w-full h-auto px-[64px]">
                <div className="w-[1232px] h-[1078px] ml-[10px] flex flex-col items-center justify-center text-black">
                    <div className="mb-[50px]">
                        <h1 className="text-center text-6xl font-bold">QUINOA VEGGIE</h1>
                        <br />
                        <h1 className="text-center text-6xl font-bold">STIR FRY</h1>
                    ...
                    <Image src={"/recipe3.png"} alt="recipe1" width={1232} height={640}></Image>
                </div>
